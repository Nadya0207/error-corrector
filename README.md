...
## ***@text_eater_bot - название в телеграм.***
...
1. Улучшение интерфейса бота для более интуитивного введения данных и более корректного сохранения данных. Это предполагается осуществить через добавление в бот специального режима печати, отдельного от режима просмотра.

2. Расширение данных о неисправляемых ошибках за счет привлечения большего количества пользователей.

3. Улучшить программу анализа данных. 

4. Специализировать функционал данного бота только на выдаче апвоутов (сделать аналог в тг ютуб-каналу).
